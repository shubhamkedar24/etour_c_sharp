...
function Profile() {
    ...
    useEffect(() => {
        ...
        // fetch("https://localhost:44337/api/customers")
            .then(res => res.json())
    ...
    useEffect(() => {
        ...
        fetch("https://localhost:44337/api/tourpackages/")       
            .then(res => res.json())
    ...
    useEffect(() => {
        ...
        fetch("https://localhost:44337/api/booking/" + user.cust_Id)
            .then(res => res.json())
    ...
    const handledelete = (passid) => {
        ...
        fetch("https://localhost:44337/api/cancelBooking/" + passid, {
            method: 'Put',
        }).then(r => {
            console.log(r.json()); 
            alert("Sucessfully Created Request for Cancel Tour.....Wait for Admin to approve");
        ...
        <div className="container">
            ...
            <div className="row">
                <div className="col-12 mt-3">
                    ...
                    {customer.map(cust => (<>
                    {/* { Object.entries(customer).map(cust => (<> */}
                        <Row className="mb-3">
